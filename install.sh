...
# Created by @zwpseudo - https://shaddixlyric.com
...
echo -e "$RESET"
echo -e "$OKORANGE + -- --=[ https://shaddixlyric.com $RESET"
echo -e "$OKORANGE + -- --=[ Sn1per by @zwpseudo $RESET"
echo ""
...
git clone https://github.com/zwpseudo/BruteX.git 
git clone https://github.com/zwpseudo/Findsploit.git 
git clone https://github.com/zwpseudo/Goohak.git
git clone https://github.com/zwpseudo/BlackWidow
git clone https://github.com/zwpseudo/Sublist3r.git
git clone https://github.com/nccgroup/shocker.git 
git clone https://github.com/BishopFox/spoofcheck.git
git clone https://github.com/arthepsy/ssh-audit 
git clone https://github.com/zwpseudo/jexboss.git
git clone https://github.com/maurosoria/dirsearch.git
git clone https://github.com/jekyc/wig.git
git clone https://github.com/RUB-NDS/CORStest.git
git clone https://github.com/hisxo/gitGraber.git
git clone https://github.com/zwpseudo/LinkFinder
...
wget https://raw.githubusercontent.com/zwpseudo/Exploits/master/defcon_webmin_unauth_rce.rb -O ~/.msf4/modules/exploits/web/defcon_webmin_unauth_rce.rb
